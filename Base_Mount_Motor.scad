...
//        translate([0, 0, -1]) {
//            cylinder(8, 2.15, 2.15); 
//        }
//        cylinder(20, 1.95, 1.95, center = true);
//        translate([-0.75, 0, -1]) {
//            cube([1.5, 10, 20]);
//        }   
//    }
...
//            cube([15, 15, 11], center = true);
//            translate ([0,0,1]) {
//                // This is the inner box that we subtract
//                cube([14.5, 14.5, 12], center = true);
//                }
//            
//        
//           translate ([-4,7,-3.5]) {
...
difference(){
    cylinder(8, 1.95, 1.95, $fn = 7);
    translate([0,0,-1]){
        cylinder(20, 1.65, 1.65, $fn = 10);
    }
    translate([-0.75, 0, -1]) {
        cube([1.5, 10, 20]);
    }   
